...
class TestDBStorageAllNoClass(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_all_no_class_one_obj(self):
        """Test all with no class passed returns dict with one added object"""
        new_state = State()
        new_state.name = 'California'
        models.storage.new(new_state)
        self.assertEqual(models.storage.all(), {new_state.id: new_state})
